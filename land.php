...
@media (max-width: 960px) {
  ...
  padding: 0 15px;
    ...
    <div class="container">
        ...
        <div class="squares">
            <a href="http://localhost/_Project/Asset%20Register/asset.php" class="square square-left">
                <div class="square-content">
                    <h3>To Register Data into the Asset Register</h3>
                </div>
            </a>
            <a href="http://localhost/_Project/Asset%20Register/report.php" class="square square-right">
                <div class="square-content">
